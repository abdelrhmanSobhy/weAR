    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
        <div className="space-y-6">
          ...
          {user && (
            <section
              className={`${customerTheme.card} space-y-2 p-5`}
            ...
            >
              ...
              {user.phoneNumber && (
                <p className="text-sm text-[#6F625B]">{user.phoneNumber}</p>
              )}
            </section>
          )}
          ...
          {/* ── Delivery address ───────────────────────────────────── */}
          <section
            className={`${customerTheme.card} space-y-4 p-5`}
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <Link
                ...
                className={cn(
                  "text-sm font-semibold text-[#9c6b54] hover:text-[#7d5643]",
            ...
            {addressesQuery.isLoading && (
              <p className="text-sm text-[#6F625B]">Loading addresses…</p>
            )}
            ...
            {!addressesQuery.isLoading && addresses.length === 0 && (
              <div className="rounded-2xl border border-dashed border-[#e8ddd5] p-6 text-center">
                ...
                <Button
                  asChild
                  variant="outline"
                  className={cn("mt-3 rounded-full", customerTheme.focusRing)}
                >
          ...
          {/* ── Payment form (shown after address step) ────────────── */}
          {(step === "payment" || step === "processing") && (
            <section
              className={`${customerTheme.card} space-y-5 p-5`}
            ...
            >
              ...
              >
                ...
                <div className="relative pb-5">
                  <label className="mb-1.5 block text-sm text-[#6F625B]">
                    Cardholder name
                  </label>
                  <input
                    type="text"
                  ...
                  >
                    ...
                    <div className="flex flex-1 justify-between gap-2 min-w-0">
                      <div>
                        ...
                        {item.brand && (
                          <p className="text-xs text-[#9c6b54]">{item.brand}</p>
                        )}
                        <p className="text-sm text-[#6F625B]">
        ...
        {/* ── Summary sidebar ────────────────────────────────────── */}
        <aside
          className={`${customerTheme.card} h-fit space-y-5 p-6`}
          aria-label="Order totals"
        >
          <h2 className="text-xl font-['Playfair_Display'] font-normal text-[#2F2925]">
            Order total
          </h2>
          <dl className="space-y-3 text-sm">
            <div className="flex justify-between">
              <dt className="text-[#6F625B]">
            ...
            <div className="flex justify-between border-t border-[#e8ddd5] pt-3">
              <dt className="font-['Playfair_Display'] font-normal text-[#2F2925]">
                Total
              </dt>
          ...
          {step === "address" && (
            <Button
              type="button"
              className={cn(
                "w-full rounded-full bg-[#9c6b54] text-white hover:bg-[#7d5643]",
                customerTheme.focusRing,
              )}
          ...
          <Button
            asChild
            variant="outline"
            className={cn("w-full rounded-full", customerTheme.focusRing)}
          >
            <Link to={CUSTOMER_ROUTES.cart}>Back to Cart</Link>
          </Button>
        </aside>
